...
def train():
    ...
    if args.validation_epoch > 0:
        setup_eval()
        val_dataset = COCODetection(image_path1=cfg.dataset.valid_images1,
                                    image_path2=cfg.dataset.valid_images2,
    ...
    if args.resume is not None:
        ...
        if cfg.backbone.path is not None:
    ...
    yolact_net(torch.zeros(1, 6, cfg.max_size, cfg.max_size).cuda())
