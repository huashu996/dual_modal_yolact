...
# These are in BGR and are for kitti_dual/images
MEANS1 = (95.88, 98.76, 93.83)
STD1   = (81.2, 80.13, 78.78)

# These are in BGR and are for kitti_dual/lidar_ddm_jet
MEANS2 = (44.73, 44.73, 44.73)
STD2   = (48.18, 48.18, 48.18)
...
dataset_base = Config({
    ...
    'train_images1': './data/kitti_dual/images/',
    'train_images2': './data/kitti_dual/lidar_ddm_jet/',
    'train_info': 'path_to_train_annotation_file',

    # Validation images and annotations.
    'valid_images1': './data/kitti_dual/images/',
    'valid_images2': './data/kitti_dual/lidar_ddm_jet/',
    'valid_info': 'path_to_valid_annotation_file',
